        ...
        <div class="row">
            <div class="col-12 col-md-7 col-lg-8">
                <div class="container-fluid">
                    ...
                    <h5 class="poppins-regular font-weight-bold full-box text-center">Colombiana Personal</h5>
                    <div class="bag-item full-box">
                        <figure class="full-box">
                            <img src="<?php echo SERVERURL; ?>vistas/assets/img/colombiana.jpg" class="img-fluid" alt="producto_nombre">
                        </figure>
                        <div class="full-box">
                            <div class="container-fluid">
                                <div class="row">
                                    ...
                                    <div class="col-12 col-lg-4 text-center mb-4">
                                        <span class="poppins-regular font-weight-bold" >SUBTOTAL: $5.000</span>
                                    </div>
                    ...
                    <h5 class="poppins-regular font-weight-bold full-box text-center">Botella de agua Cielo</h5>
                    <div class="bag-item full-box">
                        <figure class="full-box">
                            <img src="<?php echo SERVERURL; ?>vistas/assets/img/cielo.jpg" class="img-fluid" alt="producto_nombre">
                        </figure>
                        <div class="full-box">
                            <div class="container-fluid">
                                <div class="row">
